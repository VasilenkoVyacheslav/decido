...
<?php endif; ?>
    ...
    <div class="filter" data-premmerce-filter>
        <?php foreach ($attributes as $attribute): ?>
            ...
            <div class="filter__item <?php echo 'filter__item--type-' . $attribute->html_type; ?>" data-premmerce-filter-drop-scope>
                ...
                <div class="filter__header" <?php echo $dropdown ? 'data-premerce-filter-drop-handle' : ''; ?>>
