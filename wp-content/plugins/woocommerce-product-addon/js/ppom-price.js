...
jQuery(function($){
    ...
    PPOMWrapper.find('select,input:checkbox,input:radio,input[type="number"]').on('change', function(e){
...
function ppom_update_option_prices() {
    ...
    jQuery(ppom_all_option_prices).each(function(i, option) {
        ...
        total_price_label += ' '+ ppom_get_wc_price(ppom_total_price).html()+'x'+option.measure;
        ...
        ppom_total_price = parseFloat( ppom_total_price ) * parseFloat( option.measure );
...
function ppom_update_get_prices() {
    ...
    PPOMWrapper.find('select,input:checkbox,input:radio,input[type="number"]').each(function(i, input){
