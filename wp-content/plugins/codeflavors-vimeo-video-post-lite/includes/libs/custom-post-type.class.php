...
class CVM_Video_Post_Type{
 ...
 // store help screens info
	...
	public function plugin_meta( $meta, $file ){
		...
		if( $file == $pro_file ){
			$meta[] = '<span class="file-error">' . __( 'To activate Vimeo Video Post you must first deactivate <strong>CodeFlavors Vimeo Video Post Lite</strong>.', 'codeflavors-vimeo-video-post-lite' ) . '</span>';
		}
		return $meta;
	}
...
<?php
	...
	public function privacy_policy(){
		...
		wp_add_privacy_policy_content( 'CodeFlavors Vimeo Video Post', $policy_content );
	}
