...
If you would like to create video posts from hidden Vimeo videos you will need [Vimeo Video Post PRO](https://codeflavors.com/vimeo-video-post/?utm_source=wordpressorg&utm_medium=readme&utm_campaign=vimeo-lite-plugin-readme "Vimeo WordPress plugin").

= How do I import more than one tag per video spost? =

Again, this is a PRO feature. You will need [Vimeo Video Post PRO](https://codeflavors.com/vimeo-video-post/?utm_source=wordpressorg&utm_medium=readme&utm_campaign=vimeo-lite-plugin-readme "Vimeo WordPress plugin") to do this.
...
* Implemented filters [cvm_video_post_title](https://codeflavors.com/documentation/vimeo-video-post-filters/cvm_video_post_title/?utm_source=wordpressorg&utm_medium=readme&utm_campaign=vimeo-lite-plugin-readme), [cvm_video_post_content](https://codeflavors.com/documentation/vimeo-video-post-filters/cvm_video_post_content/?utm_source=wordpressorg&utm_medium=readme&utm_campaign=vimeo-lite-plugin-readme), [cvm_video_post_excerpt](https://codeflavors.com/documentation/vimeo-video-post-filters/cvm_video_post_excerpt/?utm_source=wordpressorg&utm_medium=readme&utm_campaign=vimeo-lite-plugin-readme) and [cvm_video_post_status](https://codeflavors.com/documentation/vimeo-video-post-filters/cvm_video_post_status/?utm_source=wordpressorg&utm_medium=readme&utm_campaign=vimeo-lite-plugin-readme).
...
* Now compatible with the [tutorial](https://codeflavors.com/documentation/vimeo-video-post-wp-plugin-tutorials/using-vimeo-video-post-plugin-in-wp-theme/?utm_source=wordpressorg&utm_medium=readme&utm_campaign=vimeo-lite-plugin-readme "Using Vimeo video post plugin in WordPress theme") on how to create template files for the custom post type.
...
= 1.2.6 =
After upgrading to this version, single video imports won't work anymore unless you enter your Vimeo App client identifier and client secret. More about how to register an App on Vimeo here: [How to setup Vimeo OAuth](https://codeflavors.com/documentation/vimeo-video-post-wp-plugin/vimeo-oauth/?utm_source=wordpressorg&utm_medium=readme&utm_campaign=vimeo-lite-plugin-readme "Vimeo OAuth setup")
...
If anything is wrong on your installation, please post on [CodeFlavors forums](https://codeflavors.com/codeflavors-forums/forum/vimeo-video-post-for-wordpress/?utm_source=wordpressorg&utm_medium=readme&utm_campaign=vimeo-lite-plugin-readme "CodeFlavors Community Forums") the theme you're using, WordPress version and browser/device used for testing. 