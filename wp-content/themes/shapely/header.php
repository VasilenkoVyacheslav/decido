    ...
    <div id="page" class="site loading closed-page">
        ...
        <div id="page-inner" class="">
            ...
            <a class="skip-link screen-reader-text"
               href="#content"><?php esc_html_e('Skip to content', 'shapely'); ?></a>
            ...
            <?php } ?>
            <header id="masthead"
                    class="site-header<?php echo get_theme_mod('mobile_menu_on_desktop', false) ? ' mobile-menu' : ''; ?>"
                    role="banner">
                                ...
                                <div class="module left site-title-container">
                                    <a href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>">
                                        <img class="light-logo"
                                             src="<?php echo get_template_directory_uri(); ?>/images/Decido-logo-light.svg"
                                             alt="<?php bloginfo('name'); ?>"/>
                                        <img class="dark-logo"
                                             src="<?php echo get_template_directory_uri(); ?>/images/Decido-logo-dark.svg"
                                             alt="<?php bloginfo('name'); ?>"/>
...
<?php
            ...
            <div id="content" class="main-container">
                ...
                <section class="content-area <?php echo (get_theme_mod('top_callout', true)) ? '' : ' pt0 '; ?>">
                    <div id="main"
                         class="closed-f <?php echo (!is_page_template('page-templates/template-home.php') && !is_page_template('page-templates/template-widget.php')) ? 'container' : ''; ?>"
                         role="main">
